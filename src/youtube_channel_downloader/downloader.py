...
def download_videos(
    ...
    if skip_existing and csv_exists:
        try:
            ...
            if downloaded_ids:
                console.print(f"[cyan]Found {len(downloaded_ids)} already downloaded videos - will skip them[/cyan]")
            ...
            try:
                ...
                if video_info:
                    metadata = {
                        ...
                        'filesize': video_info.get('filesize', video_info.get('filesize_approx', '')),
